...
| `--config-dir` | `OP_CONFIG_DIR` | *None* | Optional: Path to 1Password (op) config directory Defaults to standard op config locations if not provided, e.g. $XDG_CONFIG_HOME/op |
