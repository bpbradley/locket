...
| `--secret` | `SECRET_VALUE` | *None* | Additional secret values specified as LABEL=SECRET_TEMPLATE Multiple values can be provided, separated by semicolons. Or supplied multiple times as arguments |
